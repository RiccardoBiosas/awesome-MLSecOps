...
export const TOOL_CATEGORIES: ToolCategory[] = [
  {
    ...
    query: "LLM security tools and resources",
    metaDescription: "LLM security tools and resources for prompt injection testing, AI red teaming, guardrails, vulnerability scanning, and evaluation.",
    ...
    entryScope: "Its MLSecOps relevance is the testing or control of prompts, model behavior, retrieval paths, tool calls, outputs, or guardrails under adversarial input.",
  ...
  },
  {
    ...
    entryScope: "Its MLSecOps relevance is the inspection or validation of model artifacts, notebooks, code, dependencies, or model behavior before release and deployment.",
  ...
  },
  {
    ...
    entryScope: "Its MLSecOps relevance is the controlled evaluation of evasion, poisoning, extraction, inversion, privacy attacks, or robustness under an explicit attacker model.",
  ...
  },
  {
    ...
    entryScope: "Its MLSecOps relevance is the protection of model provenance, artifact integrity, dependencies, signing, bills of materials, registries, or delivery pipelines.",
  ...
  },
  {
    ...
    entryScope: "Its MLSecOps relevance is the security of agent identities, tool permissions, memory, credentials, approval paths, sandboxes, runtime actions, or MCP integrations.",
  ...
  },
  {
    ...
    entryScope: "Its MLSecOps relevance is the reduction or measurement of sensitive-data exposure through differential privacy, anonymization, encrypted computation, or privacy attack testing.",
